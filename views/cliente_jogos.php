...
<!-- 
                                    ...
                                    <td>
                                        <?php
                                            $valor['data_inicio'] = date("d/m/Y", strtotime($valor['data_inicio']));
                                            echo $valor['data_inicio'];
                                        ?>
                                    </td>
                                    <td>
                                        <?php
                                            $valor['data_fim'] = date("d/m/Y", strtotime($valor['data_fim']));
                                            echo $valor['data_fim'];
                                        ?>
                                    </td>
